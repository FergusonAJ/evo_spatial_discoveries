...
ggplot(df_plot, aes(x = x_first, y = y_first)) + 
  geom_point(alpha = 0.25)

ggplot(df_plot, aes(x = x_first, y = y_first, xend = x_last, yend = y_last)) + 
  geom_segment(alpha = 0.1)

ggplot(df_plot, aes(x = x_first, y = y_first, xend = adj_x_last, yend = adj_y_last)) + 
...
ggplot(df_plot, aes(x = distance, y = update_offset)) + 
